...
# os.chdir("./bdd100k_images_100k")
train_path = "./bdd100k_det_20_labels_trainval/labels/det_20/det_train.json"
...
for ind1 in range(len(trlabel)):
    print(ind1)
    if ind1 in [6879, 15376, 15763, 19525, 19705, 28516, 28852, 31942, 34556, 39770]:
        continue
...
plt.scatter(yolo_anchor_average[:, 0],
            yolo_anchor_average[:, 1], c='red', s=50)
...
fig, ax = plt.subplots()
for ind in range(9):
    rectangle = plt.Rectangle((304-yoloV3anchors[ind, 0]/2, 304-yoloV3anchors[ind, 1]/2),
                              yoloV3anchors[ind, 0], yoloV3anchors[ind, 1], fc='b', edgecolor='b', fill=None)
